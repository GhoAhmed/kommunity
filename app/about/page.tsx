...
const About = () => {
  return (
    <div className="flex flex-col min-h-screen px-6 sm:px-10 md:px-20 lg:px-32 py-16 sm:py-20 md:py-24">
      <h1 className="text-4xl font-bold mb-8 text-center">About KOmmunity</h1>
      <p className="text-lg leading-relaxed text-gray-700 dark:text-gray-300 max-w-4xl mx-auto text-center">
        KOmmunity is a smart platform designed to empower communities, streamline communication, and enhance collaboration between members and leaders.
        <br />
